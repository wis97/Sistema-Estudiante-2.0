...
CREATE DATABASE IF NOT EXISTS `bd_sistema_estudiante` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Volcando estructura para procedimiento bd_sistema_estudiante.ListaEstI
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `ListaEstI`()
BEGIN
SELECT cedula,nombre,apellido1,telefono,direccion,fechaNacimiento,genero,tipo
FROM tbl_estudiante 
WHERE estado = 'I'; 
END//
DELIMITER ;
...
SELECT descripcion AS 'Código del curso',
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_actividades: ~57 rows (aproximadamente)
...
INSERT INTO `tbl_actividades` (`id_actividades`, `nombre`, `fecha`, `hora`, `accion`) VALUES
	...
	(28, 'wittmann', '2017-12-16', '13:50:03', 'Inicio Sesion'),
	(29, 'wittmann', '2017-12-16', '13:51:05', 'Inactivo curso'),
	(30, 'wittmann', '2017-12-16', '13:51:10', 'Inactivo curso'),
	(31, 'wittmann', '2017-12-16', '13:51:14', 'Inactivo curso'),
	(32, 'wittmann', '2017-12-16', '13:51:18', 'Inactivo curso'),
	(33, 'wittmann', '2017-12-16', '13:51:22', 'Inactivo curso'),
	(34, 'wittmann', '2017-12-16', '13:51:37', 'Agrego un curso'),
	(35, 'wittmann', '2017-12-16', '13:51:54', 'Inactivo curso'),
	(36, 'wittmann', '2017-12-16', '14:02:49', 'Inicio Sesion'),
	(37, 'wittmann', '2017-12-16', '14:03:53', 'Inicio Sesion'),
	(38, 'Wis', '2017-12-16', '14:05:28', 'Inicio Sesion'),
	(39, 'Wis', '2017-12-16', '14:05:28', 'Inicio Sesion'),
	(40, 'Wis', '2017-12-16', '14:05:33', 'Cerrar Sesion'),
	(41, 'Wis', '2017-12-16', '14:06:05', 'Inicio Sesion'),
	(42, 'Wis', '2017-12-16', '14:07:25', 'Agrego un curso'),
	(43, 'Wis', '2017-12-16', '14:07:29', 'Inactivo curso'),
	(44, 'Wis', '2017-12-16', '14:07:33', 'Inactivo curso'),
	(45, 'Wis', '2017-12-16', '14:07:37', 'Inactivo curso'),
	(46, 'Wis', '2017-12-16', '14:07:58', 'Inactivo curso'),
	(47, 'Wis', '2017-12-22', '13:39:48', 'Inicio Sesion'),
	(48, 'Wis', '2017-12-22', '13:43:24', 'Inicio Sesion'),
	(49, 'Wis', '2017-12-22', '13:44:42', 'Agrego un nuevo estudiante'),
	(50, 'Wis', '2017-12-29', '16:45:58', 'Inicio Sesion'),
	(51, 'Wis', '2017-12-29', '16:50:35', 'Inicio Sesion'),
	(52, 'Wis', '2017-12-29', '16:51:30', 'Inicio Sesion'),
	(53, 'Wis', '2017-12-29', '16:51:57', 'Agrego un nuevo estudiante'),
	(54, 'Wis', '2017-12-29', '16:52:53', 'Inactivo curso'),
	(55, 'Wis', '2017-12-29', '17:09:15', 'Inicio Sesion'),
	(56, 'Wis', '2017-12-29', '17:10:42', 'Inicio Sesion'),
	(57, 'Wis', '2017-12-29', '17:12:25', 'Inicio Sesion'),
	(58, 'Wis', '2017-12-29', '17:16:02', 'Inicio Sesion'),
	(59, 'Wis', '2017-12-29', '17:32:34', 'Inicio Sesion'),
	(60, 'Wis', '2017-12-29', '17:41:06', 'Inicio Sesion'),
	(61, 'Wis', '2017-12-29', '17:41:31', 'Activo estudiante');
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_curso: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_estudiante: ~3 rows (aproximadamente)
...
INSERT INTO `tbl_estudiante` (`cedula`, `nombre`, `apellido1`, `apellido2`, `telefono`, `direccion`, `correo`, `fechaNacimiento`, `genero`, `estado`, `tipo`, `foto`) VALUES
	...
	(604420756, 'Ale', 'Melendez', 'Molina', '86569216', 'Ciudad Neily, Salas Vindas', 'ale@gmail.com', '21/10/1997', 'F', 'A', 'Bachiller Por Madurez', 'C:\\Users\\Luis Duarte\\Documents\\GitHub\\Sistema_Estudiante\\SistemaEstudiante\\bin\\Debug\\Recursos\\604420756.png'),
	(678611781, 'prueba', 'prueba', 'prueba', '81782132', 'rio claro', 'jnjk@gmail.com', '20/07/1997', 'M', 'A', 'Bachiller Por Madurez', 'C:\\Users\\Luis Duarte\\Documents\\GitHub\\Sistema_Estudiante\\SistemaEstudiante\\bin\\Debug\\Recursos\\678611781.png');
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_usuario_actual: ~0 rows (aproximadamente)
