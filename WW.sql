...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `inModCurso`(in p_id INT(16),	   
...
IF usDis = 0
THEN CALL InsertarCurso(p_id, p_nombre, p_descripcion,	p_estado);
ELSEIF usDis != 0
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_actividades: ~11 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_curso: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_deuda: ~18 rows (aproximadamente)
...
INSERT INTO `tbl_deuda` (`id_pago`, `deuda`, `fecha`, `observaciones`, `estado`, `tbl_estudiante_cedula`) VALUES
	(176, 'D', '2017-11-08', NULL, 'A', 116820261),
	(177, 'D', '2017-11-08', NULL, 'A', 411231231),
	(178, 'D', '2017-11-08', NULL, 'A', 678611781);
...
-- Volcando datos para la tabla bd_sistema_estudiante.tbl_usuario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tbl_usuario` DISABLE KEYS */;
INSERT INTO `tbl_usuario` (`id_administrador`, `nombreUsuario`, `contraseña`, `tipo`, `respuestaS`, `tipoPregunta`) VALUES
	(1, 'wittmann', '123', 'A', 'negro', '2');
